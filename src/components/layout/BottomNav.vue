...
const navItems = [
  {
    path: '/tracking',
    label: 'Tracking',
    icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 6.5h11v11h-11z"/><path d="M12 2v4"/><path d="M12 18v4"/><path d="M2 12h4"/><path d="M18 12h4"/></svg>`
  },
  {
    path: '/planning',
    label: 'Planung',
...
/* Sechs Reiter passen auf 360 px. Darunter wird es eng: dann nur noch Icons,
   die Beschriftung faellt weg statt umzubrechen. */
